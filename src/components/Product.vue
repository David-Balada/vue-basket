<script setup>
defineProps(["product"]);
defineEmits(["remove-item", "decrement-quantity", "increment-quantity"]);
</script>
...
<template>
  <div class="mb-2.5 ">
    <div class="flex items-center p-4">
      ...
      <div class="w-64 flex items-center flex-row">
        <div class="quantity">
          <button
              class="decrement-btn"
        ...
        <button class="trash-btn" @click="$emit('remove-item', product.id)">
